...
class BookItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_item" do
    assert_difference('BookItem.count') do
      post book_items_url, params: { book_item: { book_id: @book_item.book_id, referenceCode: @book_item.referenceCode } }
    end
  ...
  test "should update book_item" do
    patch book_item_url(@book_item), params: { book_item: { book_id: @book_item.book_id, referenceCode: @book_item.referenceCode } }
